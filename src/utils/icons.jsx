...
export const SettingsIcon = () => (
  <svg className='w-5 h-5 text-[#aaaaaa] cursor-pointer hover:text-white' fill="currentColor" viewBox="0 0 24 24">
    <path d="M19.14,12.94c0.04-0.3,0.06-0.61,0.06-0.94c0-0.32-0.02-0.64-0.07-0.94l2.03-1.58
      ...
      l0.36-2.54c0.59-0.24,1.13-0.56,1.62-0.94l2.39,0.96c0.22,0.08,0.47,0,0.59-0.22
...
export const ExpandIcon = () => (
  <svg className='w-5 h-5 text-[#aaaaaa] cursor-pointer hover:text-white' fill="currentColor" viewBox="0 0 24 24">
    <path d="M21 3H3v18h18V3zm-2 16H5V5h14v14zM11 7h2v4h4v2h-4v4h-2v-4H7v-2h4z"/>
  </svg>
)
